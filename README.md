...
UGC HQ is a job board for creators who want paid UGC work without checking every marketplace one by one.
...
- `Opportunities`: the main feed of paid UGC jobs, filterable by niche, platform, and content type.
- `Platforms`: a directory of UGC platforms with signup links, pay ranges, and fit notes.
- `Saved`: a shortlist of jobs to apply to later.
...
4. Add community-submitted gigs.
